...
<body class="login-page">
    <div id="app">
        ...
        <div class="login-logo">
            <a href="{{ url('/home').addlang() }}"><b>Admin</b>LTE</a>
        </div><!-- /.login-logo -->
        ...
        <div class="login-box-body">
            ...
            <a href="{{ url('/login').addlang() }}">Log in</a><br>
            <a href="{{ url('/register').addlang() }}" class="text-center">{{ trans('adminlte_lang::message.registermember') }}</a>
